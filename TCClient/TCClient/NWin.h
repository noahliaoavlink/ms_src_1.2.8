...
class WinMsgCallback2
{
   public:
    virtual void* WinMsg(HWND hWnd,int iMsg,void* pParameter1,void* pParameter2) = 0;
};
...
public:
	...
	void SetCallback(WinMsgCallback2* pCallback);
